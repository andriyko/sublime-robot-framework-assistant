...
"""
# Attention!!! This module was edited to match needs of this project.
# Robot Framework Keywords examples(third td in keyword row) are in 'table' tags.
# So made minor change for 'td' tag:
# insert '  '(two white spaces) instead of new line.
# Did not find real need to override huge 'handle_tag' method for such minor change.
