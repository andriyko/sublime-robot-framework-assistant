...
**Version 1.2.0 is not backward compatible. Please reinstall plugin and clean up old settings.**

**This plugin conflicts with [sublime-robot-plugin](https://github.com/shellderp/sublime-robot-plugin).**
